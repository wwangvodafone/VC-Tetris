================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : Tetris プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した Tetris には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには Tetris アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
Tetris.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CTetrisApp アプリケーション クラス
    の宣言をします。

Tetris.cpp
    このファイルは CTetrisApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\Tetris.ico
    ...
    リソース ファイル Tetris.rc によってインクルードされます。
...
TetrisDlg.h, TetrisDlg.cpp - the dialog
    Tこれらのファイルは CTetrisDlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な Tetris.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) Tetris.pch や既にコン 
